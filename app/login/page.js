...
const Login = () => {
    ...
    return (
        <div className='text-white py-14 container mx-auto'>
            <h1 className=' text-center text-2xl pb-10'>Login / Sign Up now to start your journey</h1>

            <div className='social-login-buttons flex flex-col gap-4 w-56 justify-center mx-auto pt-3'>
